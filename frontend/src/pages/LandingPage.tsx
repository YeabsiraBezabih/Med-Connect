            ...
            <div className="md:w-1/2 space-y-8 ">
              ...
              <div className="inline-flex items-center gap-2 bg-blue-800/30 rounded-full px-4 py-2 text-blue-100">
                ...
                <span className="text-sm font-medium ">
                  Ethiopia's Trusted Medicine Finder
                </span>
              </div>
              ...
              <p className="text-xl text-blue-100 max-w-xl">
                Connect with verified pharmacies across Ethiopia. Find
                medicines, compare prices, and get your prescriptions filled -
                all in one place.
              </p>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 mt-4 text-lg max-w-2xl mx-auto">
              Finding and purchasing medicines has never been easier. Follow
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="relative group">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Easily search our extensive database of medicines or upload
                  your prescription image. Our system will help you find exactly
                  what you need.
                </p>
              </div>
            ...
            <div className="relative group">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Compare prices and availability at pharmacies near you. Get
                  real-time stock information and distance details.
                </p>
              </div>
              <div className="absolute -right-4 top-1/2 hidden md:block">
                <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center">
            ...
            <div className="group">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Chat directly with pharmacies, confirm availability, and get
                  directions. Visit the pharmacy to complete your purchase.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-white relative">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 mt-4 text-lg max-w-2xl mx-auto">
              MedConnect provides everything you need to find and purchase
            ...
            <div className="group p-8 rounded-2xl hover:bg-gray-50 transition-all duration-300">
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Our intelligent search system helps you find medicines
                    quickly. Search by name, generic compound, or even symptoms
              ...
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    system will help pharmacies understand your needs and
                    prepare your order.
                  </p>
                </div>
              </div>
            ...
            <div className="group p-8 rounded-2xl hover:bg-gray-50 transition-all duration-300">
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Chat directly with pharmacies to confirm availability,
                    prices, and get professional advice about your medications.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="group p-8 rounded-2xl hover:bg-gray-50 transition-all duration-300">
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Every pharmacy on our platform is thoroughly verified and
                    licensed. Rest assured you're getting genuine medicines from
            ...
            <div className="group p-8 rounded-2xl hover:bg-gray-50 transition-all duration-300">
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Our system automatically notifies pharmacies when their
                    stock is 4–6 months from expiry. They can then choose to
                    list those items on the Discount Page, offering verified,
                    safe-to-use medicines at reduced prices. This helps minimize
                    waste and gives users access to affordable treatments.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-12 max-w-2xl mx-auto">
              Join thousands of Ethiopians who trust MedConnect for their
              medical needs. Registration is quick, easy, and completely free!
            </p>
